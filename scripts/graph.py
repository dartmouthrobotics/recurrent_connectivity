...
class Graph:
    ...
    def create_ridge(self, ridge):
        p1 = Pose()
        p1_scale = pu.scale_down(ridge[0][0])
        p1.position.x = p1_scale[INDEX_FOR_X]
        p1.position.y = p1_scale[INDEX_FOR_Y]

        p2 = Pose()
        p2_scale = pu.scale_down(ridge[0][1])
        p2.position.x = p2_scale[INDEX_FOR_X]
        p2.position.y = p2_scale[INDEX_FOR_Y]

        q1 = Pose()
        q1_scale = pu.scale_down(ridge[1][0])
        q1.position.x = q1_scale[INDEX_FOR_X]
        q1.position.y = q1_scale[INDEX_FOR_Y]

        q2 = Pose()
        q2_scale = pu.scale_down(ridge[1][1])
        q2.position.x = q2_scale[INDEX_FOR_X]
        q2.position.y = q2_scale[INDEX_FOR_Y]
